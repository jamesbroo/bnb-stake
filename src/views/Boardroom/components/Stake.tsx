...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(bombFinance.DSHARE, bombFinance.contracts.Boardroom.address);

  const tokenBalance = useTokenBalance(bombFinance.DSHARE);
  const stakedBalance = useStakedBalanceOnBoardroom();
  const {from, to} = useUnstakeTimerBoardroom();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('DSHARE', bombFinance.DSHARE);
        ...
        <CardContent>
          <StyledCardContentInner>
            <StyledCardHeader>
              ...
              <Label text={'DSHARE Staked'} variant="yellow" />
            </StyledCardHeader>
            <StyledCardActions>
