      ...
      {!!account ? (
        <>
          <Typography color="textPrimary" align="center" variant="h3" gutterBottom>
            DGN Staking for xDGN
          </Typography>
          <Grid container justify="center">
            {/* <Box mt={3} style={{ width: '600px' }}>
              <Alert variant="filled" severity="info">
                <b> Most rewards are generated from boardroom printing! Rewards come from:</b><br />
                - 80% of autocompounder fees are used to buy DGN on the open market<br />
                - 20% of all DGN minted - from protocol allocation, does not impact DSHARE boardroom printing.<br />
                If TWAP of DGN peg is not over 1.01, yield will be reduced.<br />
          ...
          <Box mt={5}>
            <Grid container justify="center" spacing={3}>
              ...
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#fba919' }}>1 xDGN =</Typography>
                    <Typography>{Number(xbulRate)} DGN</Typography>
                  </CardContent>
                </Card>
              </Grid>
              {/* <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#fba919' }}>
                      DGN PEG <small>(TWAP)</small>
                    </Typography>
                    <Typography>{scalingFactor} BTC</Typography>
                    <Typography>
                      <small>per 10,000 DGN</small>
                    </Typography>
                  </CardContent>
                </Card>
              </Grid> */}
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#fba919' }}>APR</Typography>
              ...
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#fba919' }}>Daily APR</Typography>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#fba919' }}>DGN Staked</Typography>
              ...
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#fba919' }}>DGN Staked USD</Typography>
                ...
                <StyledCardsWrapper>
                  ...
                  <StyledCardWrapper>
                    {/* <Box>
                      <Card>
                        <CardContent>
                          <h2>About xDGN & Rewards</h2>
                          <p><strong>Early staker bonus! Between January 24 and February 7th 50,000 DGN will be deposited as free rewards for all stakers. This will happen at randomized times.</strong></p>
                          <p>xDGN will be the governance token required to cast votes on protocol decisions.</p>
                          <p>20% of all DGN minted will be deposited into the xDGN smart contract, increasing the amount of DGN that can be redeemed for each xDGN. Rewards will be deposited at random times to prevent abuse.</p>
                          <p>Functionality will be developed around xDGN including using it as collateral to borrow other assets.</p>
