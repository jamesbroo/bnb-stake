...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(bombFinance.DGN, bombFinance.contracts.xDGN.address);

  const tokenBalance = useTokenBalance(bombFinance.DGN);
  ...
  const stakedTokenPriceInDollars = Number(useStakedTokenPriceInDollars('DGN', bombFinance.DGN)) * xbulRate;
        ...
        <CardContent>
          ...
          <StyledCardContentInner>
            <StyledCardHeader>
              ...
              <Label text={'xDGN Balance'} variant="yellow" />
            </StyledCardHeader>
            <StyledCardActions>
