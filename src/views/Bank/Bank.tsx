...
const Bank: React.FC = () => {
  ...
  let vaultUrl: string;
  if (bank.depositTokenName.includes('DGN')) {
    vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-bomb-btcb';
  } else {
    vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-dshare-wbnb';
...
const LPTokenHelpText: React.FC<{bank: BankEntity}> = ({bank}) => {
  ...
  const bombAddr = bombFinance.DGN.address;
  const bulshareAddr = bombFinance.DSHARE.address;

  let pairName: string;
  let uniswapUrl: string;
 // let vaultUrl: string;
  if (!bank.depositTokenName.includes('DSHARE')) {
    pairName = 'DGN-BNB pair';
    uniswapUrl = 'https://pancakeswap.finance/add/BNB/' + bombAddr;
 //   vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-bomb-btcb';
  } else {
    pairName = 'DSHARE-BNB pair';
    uniswapUrl = 'https://pancakeswap.finance/add/BNB/' + bulshareAddr;
 //   vaultUrl = 'https://www.bomb.farm/#/bsc/vault/bomb-dshare-bnb';
